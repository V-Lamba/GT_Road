...
void fristDesign() {
    ...
    glColor3f(1.000, 1.000, 0.000);
    renderBitmapString(30, 80, (void*)font1, "GT Road ");
    glColor3f(0.000, 1.000, 0.000);
    ...
    glColor3f(1.000, 1.000, 1.000);
    renderBitmapString(60 - 5, 50 - 40, (void*)font2, "Made By :");
    glColor3f(1.000, 0.000, 0.000);
    renderBitmapString(60 - 5, 50 - 43, (void*)font2, "Vishvesh and Aryan");
}
void display() {
